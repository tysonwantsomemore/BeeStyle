    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div>
            ...
            <p class="text-muted small mb-0">
                Tổ chức, phân cấp và quản lý các nhóm sản phẩm thời trang trong hệ thống
            </p>
        </div>

        <button
            type="button"
            class="btn btn-bee-primary btn-sm px-3"
            ...
            <tbody>
                ...
                @forelse($categories as $category)
                    ...
                    <tr>
                        ...
                        <td>
                            <strong class="font-monospace text-secondary">
                                #{{ $category->id }}
                            </strong>
                        </td>
                        ...
                        <td>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div
                                    class="avatar bg-warning-subtle text-warning rounded-circle d-flex align-items-center justify-content-center flex-shrink-0"
                        ...
                        <td>
                            ...
                            @if($category->parent)
                                ...
                                <span class="badge bg-info-subtle text-info border">
                                    ...
                                    <i class="fa-solid fa-level-up-alt rotate-90 me-1"></i>
                        ...
                        <td class="text-center">
                            ...
                            <span class="badge bg-warning-subtle text-dark border fw-bold">
                        ...
                        <td class="text-center">
                            ...
                            <form
                                action="{{ route('admin.categories.toggleStatus', $category->id) }}"
                                method="POST"
                                class="d-inline"
                            >
                        ...
                        <td class="text-end">
                            ...
                            <div class="btn-group btn-group-sm">
                                ...
                                <a
                                    href="{{ route('client.products.index', ['category' => $category->slug]) }}"
                                    target="_blank"
                ...
                @empty
                    ...
                    <tr>
                        ...
                        >
                            ...
                            Chưa có danh mục thời trang nào.
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            name="name"
                            class="form-control"
                            placeholder="Ví dụ: Áo Sơ Mi Nam, Quần Âu..."
                            required
                        >
                    ...
                    <div class="mb-3">
                        ...
                        <textarea
                            ...
                            class="form-control"
                            rows="3"
                            placeholder="Mô tả phong cách, chất liệu của nhóm sản phẩm này..."
                        ></textarea>
            ...
            >
                ...
                <div class="modal-body p-4 text-center">
                    ...
                    >
                        ...
                        Danh mục này hiện có sản phẩm.
                        Bạn sẽ không thể xóa được!
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    */
    ...
    const deleteNameSpan = document.getElementById(
        ...
        .forEach(button => {
            ...
            button.addEventListener('click', function () {
                ...
                if (count > 0) {
                    ...
                    deleteWarning.classList.remove(
                        'd-none'
                    );
