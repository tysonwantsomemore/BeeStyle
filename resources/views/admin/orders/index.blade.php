    ...
    <table class="table align-middle mb-0">
      ...
      <tbody>
        @forelse($orders as $order)
            ...
            <td>
              <div class="cursor-pointer" data-bs-toggle="modal" data-bs-target="#orderProgressModal{{ $order->id }}" role="button" title="Bấm để xem chi tiết tiến trình 6 bước của đơn hàng #{{ $order->order_code }}">
                ...
                @elseif($order->shipping_status === 'cancelled')
                  @if($order->cancelled_by === 'customer_rejected')
          ...
          <!-- MODAL XÁC NHẬN GIAO HÀNG & LƯU ẢNH BƯU TÁ GỬI VỀ KHO (PROOF OF DELIVERY - POD) -->
              ...
              <div class="modal-content border-0 shadow-2xl rounded-4 overflow-hidden">
                ...
                <form action="{{ route('admin.orders.updateStatus', $order->id) }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="modal-body p-4 text-start">
                    ...
                    <!-- Khu vực upload ảnh POD -->
                    <div class="mb-3">
                      <label class="form-label small fw-bold text-dark">
                        <i class="fa-solid fa-image text-primary me-1"></i> Tải Lên Ảnh Bưu Tá Chụp Xác Nhận (Gửi Về Kho) <span class="text-danger">*</span>:
                      </label>
                      ...
                      <small class="text-muted d-block mt-1" style="font-size: 0.72rem;">Định dạng: JPG, PNG, WEBP (Tối đa 10MB). Ảnh chụp hộp hàng trước cửa, trên tay khách hoặc biên bản ký nhận.</small>
                    </div>

                    <!-- Preview ảnh tải lên hoặc ảnh mẫu chọn nhanh -->
                    <div class="mb-3">
                    ...
                    <!-- Chọn nhanh ảnh mẫu thực tế nếu không có file máy tính -->
                    <div class="mb-3">
                      <label class="form-label small fw-semibold text-muted d-block">Hoặc chọn nhanh ảnh chụp mẫu bưu tá gửi về:</label>
          ...
          <!-- MODAL XEM ẢNH BẰNG CHỨNG GIAO HÀNG ĐÃ LƯU TẠI KHO (VIEW POD MODAL) -->
